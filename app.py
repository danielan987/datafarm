...
if map_data and map_data["last_clicked"]:
    ...
    if data and parameter in data:
        ...
        ax.plot(df.index, df[parameter], label="Soil Moisture", color="tan")
        ...
        ax2.plot(forecast_zoomed['ds'], forecast_zoomed['yhat'], label="Soil Moisture", color="tan")
        ...
        ax3.plot(historical_forecast['ds'], historical_forecast['trend'], label="Soil Moisture", color="tan")
